                                ...
                                <td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                        <tr>
                                            ...
                                            <td><input type="text" class="inp-form" name="item_id" value="<?php echo $item_id;?>"/></td>
                                            <td><input type="hidden" class="inp-form" name="user_id" value="<?php echo $user_id;?>"/>
					                            <input type="hidden" class="inp-form" name="id" value="<?php echo $id;?>"/>
                                                <input type="hidden" class="inp-form" name="status" value="<?php echo $status;?>"/></td>
                                        </tr>
                                       
                                        <tr>
                                            <th valign="top">商城名称:</th>
                                            <td><select class="inp-form" name="mall_name">
                                                    <option value="<?php echo $mall_name;?>"><?php echo $mall_name;?></option>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="inp-form" name="user_price" value="<?php echo $user_price;?>"/></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                        <tr>
                                            <th>&nbsp;</th>
                                            <td valign="top">
                                                <input type="button" value="" class="form-submit" onclick="document.editProduct.submit();"/>
