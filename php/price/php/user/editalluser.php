                                    ...
                                    <td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                            <tr>
                                                ...
                                                <td style="color: red;padding: 0 0 0 8px;">
                                                    *
                                                </td>
                                            </tr>
                                            <tr>
                                                <th valign="top">用户名:</th>
                                                <td><input type="text" class="inp-form" name="username" value="<?php echo $name ?>"></td>
                                                <td>
                                            ...
                                            <tr>
                                                <th valign="top">密码:</th>
                                                <td><input type="text" class="inp-form" name="password" value="<?php echo $password ?>"></td>
                                                <td></td>
                                            </tr>

                                            <tr>
                                                <th valign="top">邮箱:</th>
                                                <td><input type="text" class="inp-form" name="email" value="<?php echo $email ?>"></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <th>&nbsp;</th>
